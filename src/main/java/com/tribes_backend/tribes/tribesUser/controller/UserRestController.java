...
public class UserRestController {
    ...
    @Autowired
    public UserRestController(UserTRepository userTRepository, UserCrudService userCrudService, UserModelHelpersMethods userMethods, ErrorMessagesMethods errorMessages) {
